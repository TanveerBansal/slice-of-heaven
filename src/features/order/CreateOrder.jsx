  ...
  return (
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col sm:flex-row sm:items-center gap-2">
          <label className={`sm:basis-40 ${formErrors && "sm:mb-10"}`}>
            Phone number
          </label>
          <div className="grow">
            <input type="tel" name="phone" required className="input w-full" />
            {formErrors?.phone && (
              <p className="mt-2 text-xs text-red-700 p-2 bg-red-100 rounded-md">
                {formErrors.phone}
              </p>
            )}
          </div>
        ...
        <div className="mb-5 flex flex-col sm:flex-row sm:items-center gap-2 relative">
