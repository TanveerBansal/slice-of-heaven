...
function Order() {
  ...
  const fetcher = useFetcher(); //used to fectch the data of the partcular router that we mention in load()
...
export async function loader({ params }) {
  //we can't use the hook in fn, so its provided with the facility of params props
